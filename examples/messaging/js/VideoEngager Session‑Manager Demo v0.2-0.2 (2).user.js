// ==UserScript==
// @name         VideoEngager Session‑Manager Demo v0.2
// @namespace    http://tampermonkey.net/
// @version      0.2
// @description  Modular, scalable launcher for VideoEngager based on a Session‑Manager pattern
// @author       VideoEngager
...
;(function(){
  'use strict';
    ...
    // 3. Style it to cover the full viewport and be visually distinct (when shown)
    videoUiContainer.style.position = 'fixed';
    videoUiContainer.style.top = '0';
    videoUiContainer.style.left = '0';
    videoUiContainer.style.width = '100vw';    // 100% of viewport width
    videoUiContainer.style.height = '100vh';   // 100% of viewport height
    videoUiContainer.style.zIndex = '99999';   // Ensure it's on top of most other content
    videoUiContainer.style.backgroundColor = 'rgba(0, 0, 0, 0.75)'; // Semi-transparent black background
    videoUiContainer.style.color = 'white';    // Text color for any content inside
    videoUiContainer.style.boxSizing = 'border-box'; // Includes padding and border in the element's total width and height
    videoUiContainer.style.padding = '20px';   // Some padding for content

    // Add some placeholder content to know it's working when you make it visible
    const placeholder = document.createElement('p');
    placeholder.textContent = 'Video Call UI will appear here. Press ESC to hide (example functionality).';
    placeholder.style.textAlign = 'center';
    placeholder.style.fontSize = '24px';
    placeholder.style.marginTop = '40vh'; // Center it roughly
