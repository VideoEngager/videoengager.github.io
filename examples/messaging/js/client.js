...
export class VideoEngagerClient {
  ...
  setCustomAttributes (attributes) {
    return window.VideoEngager.setCustomAttributes(attributes);
  }

  setFirstMessage (msg) {
    return window.VideoEngager.setFirstMessage(msg);
  }

  setAttributeChangeMessage (msg) {
    return window.VideoEngager.setAttributeChangeMessage(msg);
  }

  setCallStartedMessage (msg) {
    return window.VideoEngager.setCallStartedMessage(msg);
  }

  setCallEndedMessage (msg) {
    return window.VideoEngager.setCallEndedMessage(msg);
  }
