...
/**
  ...
  * @private
  ...
  startVideo () {
    ...
    this.iframeInstance.allow = 'display-capture; microphone; camera';
...
function registerUILogic (elements) {
  ...
  elements.resizeBtn && elements.resizeBtn.addEventListener('click', function () {
    const windowElement = document.querySelector('.window');
