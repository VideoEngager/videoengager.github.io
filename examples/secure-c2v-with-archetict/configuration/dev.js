...
window._genesys.widgets = {
  ...
  webchat: {
    ...
    transport: {
      ...
      deploymentKey: 'dcca8e75-e8ba-4b13-94d7-d05b97a4c37a', // change this as widget deployment key
      orgGuid: '327d10eb-0826-42cd-89b1-353ec67d33f8', // change this as org guid
      markdown: true,
      interactionData: {
        routing: {
          targetType: 'QUEUE',
          targetAddress: 'callback_custom_flow', // change this as fallback queue
          priority: 2
        }
      }
    }
