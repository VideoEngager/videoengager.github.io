...
/**
  ...
  async startGenesysVideoSession () {
    ...
    const carouselSlides = [
      ...
      <div style="position: relative; width: 100%; height: 100%;">
        <img src="https://www.videoengager.com/wp-content/uploads/2020/05/image-for-slider-1-768x392.jpg" alt="First Slide" style="width: 100%; height: 100%; object-fit: cover;">
        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: white; font-size: 24px; font-weight: bold; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);">
          Loading...
        </div>
      </div>
      `,
      `
      <div style="position: relative; width: 100%; height: 100%;">
        <img src="https://www.videoengager.com/wp-content/uploads/2020/05/image-for-slider-3-768x392.jpg" alt="Second Slide" style="width: 100%; height: 100%; object-fit: cover;">
        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: white; font-size: 24px; font-weight: bold; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);">
          Loading...
        </div>
      </div>
      ...
      `
      <div style="position: relative; width: 100%; height: 100%;">
        <img src="https://www.videoengager.com/wp-content/uploads/2020/05/image-for-slider-4-768x392.jpg" alt="Third Slide" style="width: 100%; height: 100%; object-fit: cover;">
        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: white; font-size: 24px; font-weight: bold; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8);">
          Loading...
        </div>
      </div>
  ...
  * @private
  ...
  startVideo () {
    ...
    this.iframeManager.setIframe(this.iframeInstance);
...
class IframeManager {
  ...
  // Initialize the iframe object and attach load handlers
  setIframe (iframe) {
    this.iframe = iframe;
    this.loaded = false;
    this.attachLoadHandlers();
  }

  // Function to attach the iframe onload and onerror handlers
  attachLoadHandlers () {
    if (!this.iframe) {
  ...
  // Function to reset the iframe (used when creating a new one)
  reset () {
    this.iframe = null;
    this.loaded = false;
  }
