...
function VeIframeLoader({
  ...
  return iframeSrc ? (
    ...
    <div
      className="relative w-full h-full bg-gray-800 rounded-2xl overflow-hidden flex items-center justify-center"
      style={{
    ...
    >
      <div className="text-gray-400 text-lg">
        No Active call, Please click on Call button to start a video call
      </div>
    </div>
  );
}

function useVeIframeInstance(
  videoEngagerInstance?: VideoEngagerWidgetCore<GenesysIntegrationPureSocket>
) {
